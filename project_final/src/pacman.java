...
public class pacman {
	public static void main(String[] args) {
		...
		final ImageIcon successIcon = new ImageIcon("팩맨 사진/successIcon.png");
		final ImageIcon smallDot = new ImageIcon("팩맨 사진/smallDot.png");
		final ImageIcon bigDot = new ImageIcon("팩맨 사진/bigDot.png");
		final ImageIcon wall = new ImageIcon("팩맨 사진/wall.png");
		final ImageIcon enemy = new ImageIcon("팩맨 사진/enemy.png");
		final ImageIcon pacman = new ImageIcon("팩맨 사진/pacman.png");
		final ImageIcon empty = new ImageIcon("팩맨 사진/empty.png");
